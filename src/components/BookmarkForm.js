      ...
      <div className='col'>
        <form onSubmit={handleSubmit}>
          <div className='form-group row'>
            <label htmlFor='title-input' className='col-sm-2 col-form-label'>Title:</label>
            <div className='col-sm-10'>
              <input type='text' className='form-control' id='title-input' value={title} onChange={handleChangeTitle} />
            </div>
          </div>
          <div className='form-group row'>
            <label htmlFor='url-input' className='col-sm-2 col-form-label'>URL:</label>
            <div className='col-sm-10'>
              <input type='url' className='form-control' id='url-input' value={url} onChange={handleChangeUrl} />
            </div>
          </div>
          <div className='form-group row'>
            <label htmlFor='tag-input' className='col-sm-2 col-form-label'>Tags:</label>
            <div className='col-sm-10'>
              <input type='text' className='form-control' id='tag-input' value={tags} onChange={handleChangeTags} />
            </div>
          </div>
          <div className='form-group row'>
            <label htmlFor='description-textarea' className='col-sm-2 col-form-label'>Description:</label>
            <div className='col-sm-10'>
          ...
          <div className='form-group row'>
            <div className='col'>
              <label className='custom-control custom-checkbox'>
                ...
                <span className='custom-control-description col-sm-2'>Archived</span>
              </label>
            </div>
          </div>
          <div className='form-group row'>
